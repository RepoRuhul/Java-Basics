...
public class MethodsArrayList_01 {
	...
	public static void main(String[] args) {
		...
		// when you create an object ---> initial capacity (ic) is 10, it means it can store 10 data
		// when  data no 10 added, the capacity is still 10
		// When data no 11 come, then capacity will be increased to [{ic*(3/2)}+1]=16 
		// ArrayList is a class, below warning is coming for not using generic data type <>
