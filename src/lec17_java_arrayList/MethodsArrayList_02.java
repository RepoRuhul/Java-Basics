...
public class MethodsArrayList_02 {
	...
	public static void main(String[] args) {
		...
		// 9 methods in ListIterator: next(), hasNext(), remove(), previous(), hasPrevious(), previousIndex(), nextIndex(), set(), add() *********
