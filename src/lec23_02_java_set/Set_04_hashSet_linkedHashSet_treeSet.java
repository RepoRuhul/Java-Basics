...
public class Set_04_hashSet_linkedHashSet_treeSet {
	...
	public static void main(String[] args) {
		 ...
		 * interface of all set classes like TreeSet, HashSet, LinkedHashSet etc. means: TreeSet,
		 * HashSet, LinkedHashSet etc implements Set
		 * 
