...
public class CompareTwoNumberUsingRandomClass {
	...
	public static void main(String[] args) {
		// Random class choose number randomly with or without range
		Random random = new Random();
		int val1 = random.nextInt(100);
		int val2 = random.nextInt(100);
		// we can put a range of 100 or 1000 or 55 inside parentheses
		// choosing  a range is not mandatory, if no range given, 
		// it will randomly choose any number from int range (positive or negative)
