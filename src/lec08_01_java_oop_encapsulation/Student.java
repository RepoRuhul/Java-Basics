...
public class Student {
	...
	// By making method and variable private, then the access limits to the class user [this class] only
	
	// We can also give separate name, the below names are not fixed
	...
	// By using getter and setter method, private type data can be accessed to public type
