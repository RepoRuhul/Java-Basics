...
public class LandCalculator {
	...
	// it allows the same number of parameter, if parameter types are different in a different position [combination]
	...
	// line 21 vs 31, although number of parameter same, method name same, but parameter type is different
	...
	public int landCalculator(float d, int f, String e) {
		int total4 = (int)d+f+Integer.parseInt(e);
	...
	/*
	 ...
	 count number of parameter, if parameter number is same, 
