...
public class OtherMethodsFromArray {
	...
	public static void main(String[] args) {
		...
		// how can we increase the length of an Array by keeping the previous Array? [Important]:
		...
		// line 40 is for line 50 comparison
		...
		// if you need to decrease an Array or a specific size from the old Array to copy the specific range of the old array
		...
		// 3) to: the final index of the range to be copied, exclusive.(This index may lie outside the array. 10-1)
		...
		// Literal representation of an String type Array, line 107 is the best  representation of an Array
